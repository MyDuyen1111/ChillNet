...
export default function FeedPage() {
	...
	const composerOpen = searchParams.get("create") === "1";
	...
	return (
		<div className="mx-auto flex max-w-[935px] gap-8 px-4 pt-4 md:pt-[30px]">
			<div className="mx-auto w-full max-w-[470px] xl:mx-0">
				<StoryTray onCreateClick={openComposer} />
