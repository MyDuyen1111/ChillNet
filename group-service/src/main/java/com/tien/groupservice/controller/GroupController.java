...
public class GroupController {
    ...
    ApiResponse<GroupResponse> uploadGroupAvatar(
            @PathVariable String groupId, @RequestParam("file") MultipartFile file) {
        return ApiResponse.<GroupResponse>builder()
    ...
    ApiResponse<Void> joinGroup(@PathVariable String groupId, @RequestBody(required = false) JoinGroupRequest request) {
        if (request == null) {
