                ...
                <tr>
                    ...
                    <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:14px;box-shadow:0 8px 24px rgba(0,0,0,0.06);overflow:hidden;">
                        ...
                        <td align="center" style="padding:28px 20px;background:linear-gradient(135deg,#28c76f,#1e9e45);">
                            <h1 style="margin:0;color:#fff;font-size:24px;font-weight:800;letter-spacing:.2px;">Welcome to ChillNet 🎉</h1>
                        </td>
                        </tr>
                        <tr>
                        <td style="padding:28px 32px;">
                            ...
                            You’re in! Start building real connections and discover communities on <strong>ChillNet</strong>.
                            </p>
                            <a href="https://chillnet.com/start" style="display:inline-block;background:#1e9e45;color:#fff;text-decoration:none;padding:12px 20px;border-radius:10px;font-weight:700;">
                            Get Started →
                            </a>
                        </td>
                        </tr>
                        ...
                        <td align="center" style="padding:16px 24px;background:#fafbfc;font-size:12px;color:#8a909b;">
                            © 2025 ChillNet Inc · <a href="https://chillnet.com/privacy" style="color:#5aaf83;text-decoration:none;">Privacy</a> · <a href="https://chillnet.com/terms" style="color:#5aaf83;text-decoration:none;">Terms</a>
                        </td>
                        </tr>
                    </table>
                ...
                <tr>
                    <td align="center">
                        <table role="presentation" width="640" cellpadding="0" cellspacing="0" 
                            ...
                            <tr>
                                <td style="padding:28px 32px;text-align:center;">
                                    ...
                                    <p style="margin:0 0 18px 0;font-size:15px;line-height:1.6;">
                                        Welcome to <strong>ChillNet</strong>! 
                            ...
                            <tr>
                                <td align="center" 
                                    ...
                                    © 2025 ChillNet Inc · 
                                    <a href="https://chillnet.com/privacy" 
                                       style="color:#5aaf83;text-decoration:none;">Privacy</a> · 
                                    <a href="https://chillnet.com/terms" 
                        ...
                        <p style="max-width:640px;margin:10px 16px 0;font-size:12px;color:#9aa1ad;">
                            ...
                            <a href="mailto:support@chillnet.com" 
                               style="color:#1e9e45;text-decoration:none;">
                               support@chillnet.com
                            </a>
                        </p>
                    </td>
                </tr>
